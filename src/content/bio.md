...
Explainability is probably the major issue in AI today, affecting business use, regulation and public confidence.

- I recently won a National Institutes for Health (NIH) Prize for AI Explainability, achieving a global #2 ranking for a model predicting cognitive capacity from health data.

- This work combined my expertise in Design Thinking and technology communication with formal theoretical knowledge of the mathematics and algorithms. This is backed by my formal training (Imperial College AI/ML Certificate, 100%) and my foundational background in Philosophy (BA(hons) First Class), providing the ethical framework necessary for leading responsible AI adoption.

### Ecosystem Architecture & Scale

- I have designed and led the development of national and global ecosystem technology platforms, such as Cyclescheme which successfully unified thousands of independent suppliers and employers into a single digital workflow. This system scaled to generate £50M+ in annual revenue.
